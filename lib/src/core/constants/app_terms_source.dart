// lib/src/core/constants/app_terms_source.dart

class AppTermsSource {
  AppTermsSource._();
...
3. 개인정보 보호
· 본 서비스는 가능한 한 사용자 개인정보를 수집하지 않도록 설계되어 있으며, 개인정보 처리에 대한 상세한 사항은 별도의 **[개인정보처리방침]**을 통해 안내합니다.
...
· Para más información sobre cómo se maneja la privacidad, consulte nuestra [Política de Privacidad] disponible dentro de la aplicación o en el sitio web.
...
· 個人情報の取り扱いに関する詳細は、別途提供される**[プライバシーポリシー]**をご参照ください。
...
· 本服务条款(以下简称“条款”)适用于您(以下简称“用户”)使用OngiU(以下简称“本服务”)的情况。本服务是一款旨在为情绪不稳定或情绪激动的用户提供正向、安抚性语句，以帮助用户调节情绪的简单工具。
· 使用本服务即表示您同意本条款。
...
3. 隐私保护
· 本服务设计为尽可能不收集用户个人信息。
· 关于数据处理的更多信息，请参见我们单独提供的**《隐私政策》**，可在应用程序或网站中查看。
