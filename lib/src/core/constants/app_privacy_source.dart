// lib/src/core/constants/app_privacy_source.dart

class AppPrivacySource {
  AppPrivacySource._();
...
5. 어린이의 개인정보
온기는 14세 미만 아동을 포함한 모든 연령이 자유롭게 사용할 수 있는 서비스이며, 개인정보 수집이 없으므로 아동의 정보도 수집하지 않습니다.
