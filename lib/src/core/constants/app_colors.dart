...
class BoxGradientColors {
  ...
  static const List<List<Color>> gradientPalettes = [
    // 기존 팔레트
    [Color(0xFFede342), Color(0xFFff51eb)], // 1. 옐로우-핑크
    [Color(0xFF439cfb), Color(0xFFf187fb)], // 2. 블루-퍼플핑크
    [Color(0xFF0061FF), Color(0xFF60efff)], // 3. 딥블루-라이트블루
    [Color(0xFFf4f269), Color(0xFF5cb270)], // 4. 옐로우-그린
    [Color(0xFFff0f7b), Color(0xFFf89b29)], // 5. 핑크-오렌지 (선셋)
